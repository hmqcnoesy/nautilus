...
{
    public partial class Sample_Template : NautilusEntity
    {
        public const string TableName = "Sample_Template";
        public const string PrimaryKey = "Sample_Template_Id";
        public const string SequenceName = "Sq_Sample_Template";

        /// <summary>
        /// Gets or sets Sample_Template_Id, NUMBER(16) (not null)
        /// </summary>
