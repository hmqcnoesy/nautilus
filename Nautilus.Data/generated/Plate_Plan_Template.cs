...
{
    public partial class Plate_Plan_Template : NautilusEntity
    {
        public const string TableName = "Plate_Plan_Template";
        public const string PrimaryKey = "Plate_Plan_Template_Id";
        public const string SequenceName = "Sq_Plate_Plan_Template";

        /// <summary>
        /// Gets or sets Plate_Plan_Template_Id, NUMBER(16) (not null)
        /// </summary>
