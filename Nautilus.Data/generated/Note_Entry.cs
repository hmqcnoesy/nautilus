...
{
    public partial class Note_Entry : NautilusEntity
    {
        public const string TableName = "Note_Entry";
        public const string PrimaryKey = "Note_Entry_Id";
        public const string SequenceName = "Sq_Note_Entry";
        ...
        /// <summary>
        /// Gets or sets Note_Table_Name, VARCHAR2(30) (not null)
        /// </summary>
        public string Note_Table_Name { get; set; }

        /// <summary>
        /// Gets or sets Note_Table_Entry, NUMBER(16) (not null)
        /// </summary>
        public decimal Note_Table_Entry { get; set; }
