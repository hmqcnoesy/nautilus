...
{
    public partial class U_Asbestos_Level_Env : NautilusEntity
    {
        public const string TableName = "U_Asbestos_Level";

        /// <summary>
        /// Gets or sets U_Asbestos_Level_Id, NUMBER(16) (not null)
        /// </summary>
        public decimal U_Asbestos_Level_Id { get; set; }
