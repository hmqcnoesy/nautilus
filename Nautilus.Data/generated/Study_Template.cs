...
{
    public partial class Study_Template : NautilusEntity
    {
        public const string TableName = "Study_Template";
        public const string PrimaryKey = "Study_Template_Id";
        public const string SequenceName = "Sq_Study_Template";

        /// <summary>
        /// Gets or sets Study_Template_Id, NUMBER(16) (not null)
        /// </summary>
